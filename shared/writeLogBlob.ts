...
async function writeLogBlob(functionInvocationMeta, logObject)
{
    functionInvocationMeta.storageAccount
    functionInvocationMeta.storageKey
    functionInvocationMeta.logStorageContainer
